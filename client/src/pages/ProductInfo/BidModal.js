    ...
    try {
      ...
      if (response.success) {
        ...
        await AddNotification({
          title: "A new offer has been placed",
          message: `A new offer has been placed on your product ${product.name} by ${user.name} for $ ${values.bidAmount}`,
    ...
    >
      <div className="flex flex-col gap-5 mb-5">
        ...
        <Form layout="vertical" ref={formRef} onFinish={onFinish}>
          <Form.Item label="Offer Amount" name="bidAmount" rules={rules}>
            <Input />
          </Form.Item>
